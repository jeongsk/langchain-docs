...
이 가이드는 Jina [도구](/oss/integrations/tools/)를 시작하기 위한 빠른 개요를 제공합니다. 모든 Jina 기능 및 구성에 대한 자세한 문서는 [API 레퍼런스](https://python.langchain.com/api_reference/community/tools/langchain_community.tools.jina_search.tool.JinaSearch.html)를 참조하세요.
...
### [인수로 직접 호출하기](/oss/langchain/tools)
...
### [ToolCall로 호출하기](/oss/langchain/tools)
...
먼저 [도구 호출 모델](/oss/langchain/tools/)에 도구를 바인딩한 다음 호출하여 체인에서 도구를 사용할 수 있습니다:
