...
이 패키지는 웹 콘텐츠용 [document loader](/oss/integrations/document_loaders/)를 구현합니다. 기존 웹 스크레이퍼와 달리 PullMdLoader는 React, Angular 또는 Vue.js와 같은 동적 JavaScript 프레임워크로 구축된 웹 페이지를 로컬 렌더링 없이 Markdown으로 변환할 수 있습니다.
