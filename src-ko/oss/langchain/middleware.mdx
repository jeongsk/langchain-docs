...
<Note>
**중요:** 휴먼 인 더 루프 미들웨어는 중단 간 상태를 유지하기 위해 [체크포인터](/oss/langgraph/persistence#checkpoints)가 필요합니다.

전체 예제 및 통합 패턴은 [휴먼 인 더 루프 문서](/oss/langchain/human-in-the-loop)를 참조하세요.
</Note>
...
- [휴먼 인 더 루프](/oss/langchain/human-in-the-loop) - 민감한 작업에 대한 사람의 검토 추가
