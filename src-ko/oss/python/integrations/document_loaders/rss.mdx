...
RSS 피드 URL 목록에서 HTML 뉴스 기사를 다운스트림에서 사용할 수 있는 문서 형식으로 로드하는 방법을 다룹니다.
...
기사를 로드하는 데 사용하는 NewsURLLoader에 인수를 전달할 수 있습니다.
...
Feedly 내보내기와 같은 OPML 파일을 사용할 수도 있습니다. URL 또는 OPML 콘텐츠를 전달하세요.
