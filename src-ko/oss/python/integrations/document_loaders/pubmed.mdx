...
>[PubMed®](https://pubmed.ncbi.nlm.nih.gov/)는 `미국 국립생물공학정보센터, 국립의학도서관`이 제공하는 생물의학 문헌의 3,500만 개 이상의 인용을 포함하고 있습니다. 인용은 `MEDLINE`, 생명과학 저널 및 온라인 도서에서 가져옵니다. 인용에는 `PubMed Central` 및 출판사 웹 사이트의 전문 콘텐츠에 대한 링크가 포함될 수 있습니다.
