...
이 가이드는 AzureAIChatCompletionsModel [채팅 모델](/oss/langchain/models) 시작하기를 도와드립니다. AzureAIChatCompletionsModel의 모든 기능과 설정에 대한 자세한 문서는 [API 레퍼런스](https://python.langchain.com/api_reference/azure_ai/chat_models/langchain_azure_ai.chat_models.AzureAIChatCompletionsModel.html)를 참조하세요.
