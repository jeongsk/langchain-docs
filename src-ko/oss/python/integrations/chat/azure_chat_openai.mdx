...
이 가이드는 AzureOpenAI [채팅 모델](/oss/langchain/models) 시작하기를 도와드립니다.
...
사용 가능한 기능에 대한 자세한 내용은 [ChatOpenAI 문서](/oss/integrations/chat/openai/)를 참조하거나 [API 레퍼런스](https://python.langchain.com/api_reference/openai/chat_models/langchain_openai.chat_models.azure.AzureChatOpenAI.html)를 확인하세요.
...
Azure OpenAI는 [Microsoft Azure 플랫폼](https://azure.microsoft.com/en-us/products/ai-services/openai-service)에서 호스팅되는 OpenAI 모델을 의미합니다. OpenAI는 자체 모델 API도 제공합니다. OpenAI 서비스에 직접 액세스하려면 [ChatOpenAI 통합](/oss/integrations/chat/openai/)을 사용하세요.
