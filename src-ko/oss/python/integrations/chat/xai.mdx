...
이 페이지는 xAI [채팅 모델](/oss/langchain/models)을 시작하는 데 도움을 줍니다. 모든 `ChatXAI` 기능과 구성에 대한 자세한 문서는 [API 레퍼런스](https://python.langchain.com/api_reference/xai/chat_models/langchain_xai.chat_models.ChatXAI.html)를 참조하세요.
