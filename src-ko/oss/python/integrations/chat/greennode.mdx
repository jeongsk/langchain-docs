...
이 페이지는 GreenNode Serverless AI [chat models](/oss/langchain/models)을 시작하는 데 도움을 드립니다. 모든 ChatGreenNode 기능 및 구성에 대한 자세한 문서는 [API reference](https://python.langchain.com/api_reference/greennode/chat_models/langchain_greennode.chat_models.ChatGreenNode.html)를 참조하세요.
