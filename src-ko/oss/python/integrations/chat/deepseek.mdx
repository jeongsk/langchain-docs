...
이 문서는 DeepSeek의 호스팅된 [채팅 모델](/oss/langchain/models) 시작하기를 도와드립니다. 모든 ChatDeepSeek 기능 및 구성에 대한 자세한 문서는 [API 레퍼런스](https://python.langchain.com/api_reference/deepseek/chat_models/langchain_deepseek.chat_models.ChatDeepSeek.html)를 참조하세요.
