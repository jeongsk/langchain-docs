...
이 가이드는 Cerebras [채팅 모델](/oss/langchain/models) 시작하기를 위한 빠른 개요를 제공합니다. 모든 ChatCerebras 기능 및 구성에 대한 자세한 문서는 [API 레퍼런스](https://python.langchain.com/api_reference/cerebras/chat_models/langchain_cerebras.chat_models.ChatCerebras.html#)를 참조하세요.
