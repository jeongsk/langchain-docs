...
- [메시지](/oss/langchain/messages#standard-content-blocks)에 문서화된 표준화된 블록 형태
...
자세한 내용은 콘텐츠 블록 [참조](/oss/langchain/messages#content-block-reference)를 참조하세요.
...
<Note>
    자세히 알아보기: [메시지](/oss/langchain/messages#content), [표준 콘텐츠 블록](/oss/langchain/messages#standard-content-blocks), [멀티모달](/oss/langchain/messages#multimodal).
</Note>
