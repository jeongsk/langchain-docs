...
<Note>
이 섹션은 LangGraph의 구성 가능한 필드에 대한 기본적인 이해가 있다고 가정합니다. 그렇지 않은 경우 자세한 내용은 LangGraph 문서([Python](/oss/langgraph/graph-api/#add-runtime-configuration), [TypeScript](https://langchain-ai.github.io/langgraphjs/how-tos/configuration/))를 참고하세요.
</Note>
