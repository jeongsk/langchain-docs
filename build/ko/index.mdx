...
<div class="mx-auto max-w-8xl px-0 lg:px-5" style={{ paddingBottom: "8rem" }}>
    <div class="mdx-content prose prose-gray dark:prose-invert mx-4 pt-10">
        ...
        <CardGroup cols={4}>
            <Card title="Build your first agent" icon="gear" href="/oss/python/python/langchain/quickstart" cta="Get started" />
            ...
            <Card title="Build an advanced agent" icon="gears" href="/oss/python/python/langgraph/quickstart" cta="Get started"/>
        </CardGroup>
