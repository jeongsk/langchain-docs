...
Before setup, review the [overview on hybrid](/langsmith/hybrid) LangSmith.
...
<Callout icon="pen-to-square" iconType="regular">
  [Edit the source of this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/ko/langsmith/deploy-hybrid.mdx)
</Callout>
