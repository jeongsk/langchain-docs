...
<Callout icon="pen-to-square" iconType="regular">
  [Edit the source of this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/ko/langsmith/index-datasets-for-dynamic-few-shot-example-selection.mdx)
</Callout>
