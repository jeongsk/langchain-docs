...
---
This guide shows you how to set up and use LangSmith to deploy on cloud.
...
You have deployed an application using LangSmith. Here are some other resources to check out:

- The [Studio overview](/langsmith/studio)
- [Hosting options](/langsmith/hosting)

---

<Callout icon="pen-to-square" iconType="regular">
  [Edit the source of this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/ko/langsmith/deployment-quickstart.mdx)
</Callout>
