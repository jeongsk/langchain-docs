...
Before setting up LangSmith with deployment, review the [self-hosting overview page](/langsmith/self-hosted#langsmith-with-deployment).

<Info>
**Important**
Self-hosting LangSmith with deployment requires an [Enterprise](/langsmith/plans) plan.
</Info>
...
1. As part of configuring your self-hosted LangSmith instance, you enable the `langgraphPlatform` option. This will provision a few key resources.
    ...
    2. `LangGraphPlatform CRD`: A CRD for LangSmith deployments. This contains the spec for managing an instance of a LangGraph platform deployment.
...
<Callout icon="pen-to-square" iconType="regular">
  [Edit the source of this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/ko/langsmith/deploy-self-hosted-full-platform.mdx)
</Callout>
