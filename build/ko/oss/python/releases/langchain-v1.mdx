...
LangChain provides a few [prebuilt middlewares](/oss/python/python/langchain/middleware#built-in-middleware) for common patterns, including:
...
<Callout icon="pen-to-square" iconType="regular">
  [Edit the source of this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/ko/oss/python/releases/langchain-v1.mdx)
</Callout>
