...
To see the complete list of configurable capabilities and their defaults, visit the [API reference](https://reference.langchain.com/python) for your integration type. Reference pages include code examples for implementing standard tests.
...
<Callout icon="pen-to-square" iconType="regular">
  [Edit the source of this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/ko/oss/python/contributing/standard-tests-langchain.mdx)
</Callout>
