...
<Steps>
    ...
    <Step title="Add documentation">
        ...
        <Accordion title="Integration documentation guide" icon="book">
            ...
            - [Chat models](/oss/python/integrations/chat/TEMPLATE)
            - [Tools and toolkits](/oss/python/integrations/tools/TEMPLATE)
            - [Retrievers](/oss/python/integrations/retrievers/TEMPLATE)
            - Text splitters - Coming soon
            - Embedding models - Coming soon
            - [Vector stores](/oss/python/integrations/vectorstores/TEMPLATE)
...
<Callout icon="pen-to-square" iconType="regular">
  [Edit the source of this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/ko/oss/python/contributing/integrations-langchain.mdx)
</Callout>
