...
* [함수형 API를 사용하여 다른 프레임워크에 LangGraph 기능 추가하기](/langsmith/autogen-integration): 기본적으로 제공하지 않는 다른 에이전트 프레임워크에 영속성, 메모리, 스트리밍과 같은 LangGraph 기능을 추가하세요.

---

<Callout icon="pen-to-square" iconType="regular">
  [Edit the source of this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/ko/oss/python/langgraph/use-functional-api.mdx)
</Callout>
