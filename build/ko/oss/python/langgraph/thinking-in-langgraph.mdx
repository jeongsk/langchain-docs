...
To enable [human-in-the-loop](/oss/python/langgraph/add-human-in-the-loop) with `interrupt()`, we need to compile with a [checkpointer](/oss/python/langgraph/persistence) to save state between runs:
...
<CardGroup cols={2}>
  ...
  <Card title="Human input is first-class" icon="user" href="/oss/python/langgraph/add-human-in-the-loop">
...
<Callout icon="pen-to-square" iconType="regular">
  [Edit the source of this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/ko/oss/python/langgraph/thinking-in-langgraph.mdx)
</Callout>
