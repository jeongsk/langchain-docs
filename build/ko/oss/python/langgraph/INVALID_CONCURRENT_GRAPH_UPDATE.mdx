...
이러한 문제는 그래프에서 [fanout](/oss/python/langgraph/graph-api#map-reduce-and-the-send-api)이나 다른 병렬 실행을 사용하고 있고, 다음과 같이 그래프를 정의한 경우 발생할 수 있습니다:
...
<Callout icon="pen-to-square" iconType="regular">
  [Edit the source of this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/ko/oss/python/langgraph/INVALID_CONCURRENT_GRAPH_UPDATE.mdx)
</Callout>
