...
<Columns cols={2}>
    ...
    <Card title="AzureOpenAIEmbeddings" href="/oss/python/integrations/text_embedding/azureopenai.mdx" cta="Get started" icon="microsoft" arrow>
...
<Callout icon="pen-to-square" iconType="regular">
  [Edit the source of this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/ko/oss/python/integrations/providers/openai.mdx)
</Callout>
