...
Use `request.runtime` to access the [Runtime](https://langchain-ai.github.io/langgraph/reference/runtime/#langgraph.runtime.Runtime) object inside middleware decorators. The runtime object is available in the `ModelRequest` parameter passed to middleware functions.
...
<Callout icon="pen-to-square" iconType="regular">
  [Edit the source of this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/ko/oss/python/langchain/runtime.mdx)
</Callout>
