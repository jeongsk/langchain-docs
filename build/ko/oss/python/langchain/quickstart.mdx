...
<Steps>
    ...
    <Step title="Create tools">
        ...
        <Tip>
            ...
            We've defined them here as plain Python functions, but LangChain's [@tool decorator](https://reference.langchain.com/python/langchain/tools/#langchain.tools.tool) decorator is often used to add extra metadata.
        </Tip>
...
<Callout icon="pen-to-square" iconType="regular">
  [Edit the source of this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/ko/oss/python/langchain/quickstart.mdx)
</Callout>
