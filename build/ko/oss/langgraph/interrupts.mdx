...
[LangGraph Studio](/langgraph-platform/langgraph-studio)를 사용하여 그래프를 실행하기 전에 UI에서 그래프에 정적 인터럽트를 설정할 수 있습니다. 또한 UI를 사용하여 실행의 모든 지점에서 그래프 상태를 검사할 수 있습니다.
...
<Callout icon="pen-to-square" iconType="regular">
  [Edit the source of this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/ko/oss/langgraph/interrupts.mdx)
</Callout>
