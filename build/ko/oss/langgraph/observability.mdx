...
* [로컬에서 실행 중인 애플리케이션 디버그](/langgraph-platform/observability-studio#debug-langsmith-traces).
...
<Callout icon="pen-to-square" iconType="regular">
  [Edit the source of this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/ko/oss/langgraph/observability.mdx)
</Callout>
