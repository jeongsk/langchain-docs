...
`langchain` [Runnable](https://python.langchain.com/docs/concepts/runnables/) 객체(채팅 모델, 리트리버, 체인 등)는 `evaluate()` / `aevaluate()`에 직접 전달할 수 있습니다.
...
Runnable은 각 출력에 대해 적절하게 추적됩니다.

![Runnable Evaluation](/langsmith/images/runnable-eval.png)

## 관련 항목

* [`langgraph` 그래프 평가하는 방법](/langsmith/evaluate-on-intermediate-steps)
