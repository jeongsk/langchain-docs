...
Diffbot의 Extract API에는 API 토큰이 필요합니다. [무료 API 토큰을 받는 방법](/oss/python/integrations/providers/diffbot#installation-and-setup)에 대한 지침을 따른 다음 환경 변수를 설정합니다.
...
Knowledge Graph에 데이터를 계속 로드하려면 [`DiffbotGraphTransformer` 가이드](/oss/python/integrations/graphs/diffbot/#loading-the-data-into-a-knowledge-graph)를 따르세요.
