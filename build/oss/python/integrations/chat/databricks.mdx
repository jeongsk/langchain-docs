...
이 가이드는 Databricks [채팅 모델](/oss/python/langchain/models) 시작하기를 위한 빠른 개요를 제공합니다. 모든 ChatDatabricks 기능 및 구성에 대한 자세한 문서는 [API 레퍼런스](https://python.langchain.com/api_reference/community/chat_models/langchain_community.chat_models.databricks.ChatDatabricks.html)를 참조하세요.
...
UC 함수를 체인에서 사용하는 방법에 대해서는 [Databricks Unity Catalog](/oss/python/integrations/tools/databricks)를 참조하세요.
