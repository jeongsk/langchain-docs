...
이 가이드는 AI/ML API [채팅 모델](/oss/python/langchain/models)을 시작하는 데 도움을 드립니다. 모든 `ChatAimlapi` 기능 및 구성에 대한 자세한 문서는 [API 레퍼런스](https://python.langchain.com/api_reference/aimlapi/chat_models/langchain_aimlapi.chat_models.ChatAimlapi.html)를 참조하세요.
