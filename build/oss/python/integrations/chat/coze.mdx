...
coze.com의 ChatCoze 채팅 모델 API입니다. 자세한 내용은 [https://www.coze.com/open/docs/chat](https://www.coze.com/open/docs/chat)를 참조하세요.
...
또는 다음과 같이 API 키와 API 베이스를 설정할 수 있습니다:
