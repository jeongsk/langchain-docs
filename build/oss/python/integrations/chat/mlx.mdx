...
2. `ChatMLX` 클래스를 활용하여 이러한 LLM들이 LangChain의 [Chat Messages](https://python.langchain.com/docs/modules/model_io/chat/#messages) 추상화와 인터페이스할 수 있도록 합니다.
...
여기서는 `gemma-2b-it`을 제로샷 `ReAct` 에이전트로 테스트합니다. 아래 예제는 [여기](https://python.langchain.com/docs/modules/agents/agent_types/react#using-chat-models)에서 가져온 것입니다.
