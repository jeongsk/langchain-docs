...
> [Friendli](https://friendli.ai/)는 확장 가능하고 효율적인 배포 옵션으로 AI 애플리케이션 성능을 향상시키고 비용 절감을 최적화하며, 높은 수요의 AI 워크로드에 맞춰진 서비스를 제공합니다.

이 튜토리얼은 LangChain을 사용하여 채팅 애플리케이션을 위한 `ChatFriendli` 통합을 안내합니다. `ChatFriendli`는 동기 및 비동기 호출을 모두 지원하는 유연한 방식으로 대화형 AI 응답을 생성합니다.
...
`invoke`, `batch`, `generate`, `stream` 기능도 사용할 수 있습니다.
