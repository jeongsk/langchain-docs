...
이 가이드는 SambaStudio [채팅 모델](/oss/python/langchain/models) 시작에 도움을 줍니다. 모든 ChatStudio 기능 및 구성에 대한 자세한 문서는 [API 레퍼런스](https://docs.sambanova.ai/sambastudio/latest/index.html)를 참조하세요.

**[SambaNova](https://sambanova.ai/)'s** [SambaStudio](https://docs.sambanova.ai/sambastudio/latest/sambastudio-intro.html) SambaStudio는 SambaNova [DataScale](https://sambanova.ai/products/datascale) 시스템에서 모델을 학습, 배포 및 관리하는 기능을 제공하는 풍부한 GUI 기반 플랫폼입니다.
...
ChatSambaStudio 모델에 접근하려면 SambaStudio 플랫폼에서 [엔드포인트를 배포](https://docs.sambanova.ai/sambastudio/latest/language-models.html)하고 `langchain_sambanova` 통합 패키지를 설치해야 합니다.
...
SambaStudio 배포된 엔드포인트에서 URL과 API Key를 얻어 환경 변수에 추가하세요:
...
LangChain **SambaStudio** 통합은 `langchain_sambanova` 패키지에 포함되어 있습니다:
...
모든 SambaStudio 기능 및 구성에 대한 자세한 문서는 API 레퍼런스를 참조하세요: [docs.sambanova.ai/sambastudio/latest/api-ref-landing.html](https://docs.sambanova.ai/sambastudio/latest/api-ref-landing.html)
