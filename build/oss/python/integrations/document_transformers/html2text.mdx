...
>[html2text](https://github.com/Alir3z4/html2text/)는 `HTML` 페이지를 깔끔하고 읽기 쉬운 순수 `ASCII` 텍스트로 변환하는 Python 패키지입니다.

변환된 ASCII는 유효한 `Markdown` 형식(텍스트를 HTML로 변환하는 포맷)이기도 합니다.
