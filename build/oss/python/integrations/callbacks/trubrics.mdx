...
>
>`Trubrics`에 대한 자세한 내용은 [Trubrics 저장소](https://github.com/trubrics/trubrics-sdk)를 확인하세요.
...
`TrubricsCallbackHandler`는 다양한 선택적 인자를 받을 수 있습니다. Trubrics 프롬프트에 전달할 수 있는 kwargs에 대해서는 [여기](https://trubrics.github.io/trubrics-sdk/platform/user_prompts/#saving-prompts-to-trubrics)를 참조하세요.
...
다음은 LangChain [LLMs](/oss/python/langchain/models) 또는 [Chat Models](/oss/python/langchain/models)와 함께 `TrubricsCallbackHandler`를 사용하는 두 가지 예제입니다. OpenAI 모델을 사용할 것이므로 여기서 `OPENAI_API_KEY` 키를 설정하세요:
