...
>[Fiddler](https://www.fiddler.ai/)는 엔터프라이즈 생성형 및 예측 시스템 운영의 선구자로, 데이터 과학, MLOps, 리스크, 컴플라이언스, 분석 및 기타 LOB 팀이 엔터프라이즈 규모에서 ML 배포를 모니터링, 설명, 분석 및 개선할 수 있도록 통합 플랫폼을 제공합니다.
...
이 정보는 Fiddler 환경의 *Settings* 페이지로 이동하여 확인할 수 있습니다.
