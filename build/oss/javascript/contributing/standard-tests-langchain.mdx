...
To see the complete list of configurable capabilities and their defaults, visit the [API reference](https://reference.langchain.com/javascript) for your integration type. Reference pages include code examples for implementing standard tests.
