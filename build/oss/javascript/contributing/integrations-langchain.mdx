...
<Steps>
    ...
    <Step title="Add documentation">
        ...
        <Accordion title="Integration documentation guide" icon="book">
            ...
            - [Chat models](/oss/javascript/integrations/chat/TEMPLATE)
            - [Tools and toolkits](/oss/javascript/integrations/tools/TEMPLATE)
            - [Retrievers](/oss/javascript/integrations/retrievers/TEMPLATE)
            - Text splitters - Coming soon
            - Embedding models - Coming soon
            - [Vector stores](/oss/javascript/integrations/vectorstores/TEMPLATE)
