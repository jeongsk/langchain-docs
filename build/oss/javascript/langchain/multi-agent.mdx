...
* **커스텀 출력 형식** – 메인 에이전트에게 전달하기 전에 코드에서 서브 에이전트의 응답을 조정하거나 강화합니다.
  ...
  * 이를 위해서는 서브 에이전트의 응답과 커스텀 상태를 병합할 수 있도록 결과를 [`Command`](https://langchain-ai.github.io/langgraphjs/reference/classes/langgraph.Command.html) (또는 동등한 구조)로 래핑해야 합니다.
